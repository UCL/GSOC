...
primary data processing and analysis tool of the CCHIC dataset. The aim of
cleanEHR is to provide a reliable and autiable EHR data analysis tool and
establish a software-based collaboration platform. 
